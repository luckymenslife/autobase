...
namespace Rekod.Behaviors
{
    ...
    public class CommandBehavior
    {
        ...
        #region ExtraParameter
        public static object GetExtraParameter(DependencyObject obj)
        {
            return (object)obj.GetValue(ExtraParameterProperty);
        }

        public static void SetExtraParameter(DependencyObject obj, object value)
        {
            obj.SetValue(ExtraParameterProperty, value);
        }

        // Using a DependencyProperty as the backing store for ExtraParameter.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ExtraParameterProperty =
            DependencyProperty.RegisterAttached("ExtraParameter", typeof(object),
            typeof(CommandBehavior), new UIPropertyMetadata(null, new PropertyChangedCallback(OnExtraParameterChanged)));

        private static void OnExtraParameterChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.ExtraParameter = e.NewValue;
        }
        #endregion ExtraParameter
        ...
        #region Action
        //Action example:
        //public Action<object> DoSomething
        //{
        //    get
        //    {
        //        return x => MessageBox.Show("Hello");
        //    }
        //}
